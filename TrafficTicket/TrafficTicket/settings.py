...
SECRET_KEY = 'django-insecure-z&b(-2ht$m25j+np%j%zh4o^20!%sc(!=!9gt#jhfx=c!xa_*h'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['192.168.184.52','localhost','192.168.0.186','127.0.0.1','192.168.0.186']
...
ROOT_URLCONF = 'TrafficTicket.urls'
...
WSGI_APPLICATION = 'TrafficTicket.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',
        'PASSWORD': '12345678',
        'HOST': 'localhost',  # Use the appropriate host if it's a remote database.
        'PORT': '5432',       # Use the PostgreSQL port number.
    }
}
